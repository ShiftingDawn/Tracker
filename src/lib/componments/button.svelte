    ...
    const button = tv({
        ...
        variants: {
            variant: {
                ...
                outline: "border-2 border-primary rounded-full text-primary text-center hover:bg-primary/10 data-disabled:border-primary/50 data-disabled:bg-transparent",
            },
        },
